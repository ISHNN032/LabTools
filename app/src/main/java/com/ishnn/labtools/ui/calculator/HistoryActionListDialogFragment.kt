...
class HistoryActionListDialogFragment : BottomSheetDialogFragment() {
    ...
    private inner class ItemAdapter internal constructor(private val mHistoryActionList: ArrayList<String>) : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
