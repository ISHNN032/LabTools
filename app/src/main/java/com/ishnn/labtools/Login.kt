...
object Login {
    ...
    fun kakaoLogin(context: Context, callbacks: OnKakaoLoginInterface){
            ...
            if (error != null) {
                ...
                UserApiClient.instance.me { user, error ->
                    if (error != null) {
                        ...
                        this.profile = UserProfile(user.id, user.kakaoAccount!!.profile!!.nickname, URL(user.kakaoAccount?.profile?.thumbnailImageUrl))
                        callbacks.onLogin()
                    }
                }
            }
